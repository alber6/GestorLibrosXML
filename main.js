...
function actualizarTabla(){
    ...
    libros.forEach((libro, index) => {
        ...
        <tr class= "text-center"> 
            ...
            <td>
                <button class="btn btn-success text-dark w-75 m-3 fw-bold" onclick="editarLibro(${index})">Modifica</button>
                <button class="btn btn-danger text-dark w-75 m-3 fw-bold" onclick="borrarLibro(${index})">Elimina</button>
            </td>
        </tr>`;
